...
project = 'COSMIC XPCS'
copyright = '2019, Ronald J Pandolfi'
...
htmlhelp_basename = 'COSMICXPCSdoc'
...
latex_documents = [
    (master_doc, 'COSMICXPCS.tex', 'COSMIC XPCS Documentation',
...
man_pages = [
    (master_doc, 'cosmicxpcs', 'COSMIC XPCS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'COSMICXPCS', 'COSMIC XPCS Documentation',
     author, 'COSMICXPCS', 'One line description of project.',
     'Miscellaneous'),
]
